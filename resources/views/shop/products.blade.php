@extends('layouts.app')
@section('title', 'Товары магазина '. $shop->title)
@section('meta')
    ...
    <div class="container">
        <div class="store-products">
            <div class="store-products-header">
                <h1>Товары магазина {{$shop->title}}</h1>
                <p>Найдено <span>{{$shop->products->count()}}</span> товаров</p>
            </div>
            <div class="store-products-content">
                ...
                <div class="store-information">
                    ...
                    <div class="add-to-favorite-list" onclick="addTo('{{$shop->id}}', 'shop', '{{csrf_token()}}')">
                        <p>Добавить магазин в избранное</p>
                        <div class="user-control-btn">
                            <svg width="25" height="22" viewBox="0 0 25 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M18.033 0C15.6511 0 13.6159 1.70992 12.4977 2.88877C11.3795 1.70992 9.34886 0 6.96818 0C2.86477 0 0 2.88076 0 7.00447C0 11.5482 3.55795 14.4851 7 17.3258C8.625 18.6683 10.3068 20.0555 11.5966 21.5937C11.8136 21.8512 12.1318 22 12.4659 22H12.5318C12.867 22 13.1841 21.8501 13.4 21.5937C14.692 20.0555 16.3727 18.6672 17.9989 17.3258C21.4398 14.4862 25 11.5494 25 7.00447C25 2.88076 22.1352 0 18.033 0Z" fill="#FD8002"></path>
                            </svg>
                        </div>
                    </div>
