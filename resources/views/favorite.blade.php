...
@section('content')
    <div class="container">
        <div class="favorite-controls">
            <span class="active-favorite" onclick="location.href = '{{route('favorite')}}';">Товары в избранном</span>
            <span class="" onclick="location.href = '{{route('favorite.shop')}}';">Магазины в избранном</span>
        </div>
    </div>
