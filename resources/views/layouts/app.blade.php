...
<div class="container">
    ...
    <div class="menu">
        ...
        <div class="search">
            <input type="text" placeholder="Поиск по товарам" id="search_input">
            <div class="search-btn" onclick="location.href = '/search/'+document.getElementById('search_input').value;">
...
<style>
    ...
    @media (hover: hover) and (pointer: fine) {
        .btn-up:hover {
            background-color: var(--orange); /* цвет заднего фона при наведении */
        }
    }
</style>
<script>
